#  Salim Badakhchani <salim.badakhchani@bluebank.io>
#
...
ADD root /
# Fix write to error_log even though /dev/stderr is set
RUN chmod -R go+rwx /var/opt/rh/rh-nginx18
...
RUN echo "The Bluebank Bring Your Own Container demo running nginx on CentOS7" > /usr/share/nginx/html/index.html
EXPOSE 80
USER 499
